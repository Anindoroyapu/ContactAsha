...
namespace AddProductApi.Models
{
    [Table("product_list")]
    public class AddProduct
    {
        ...
        public string PricePurchase { get; set; } = string.Empty; // default: portrait or wedding
        ...
        public static async Task<List<AddProduct>> GetListAsync(AppDbContext context)
        {
            try
            {
                return await context.AddProducts.ToListAsync();
            }
            catch (Exception ex)
            {
